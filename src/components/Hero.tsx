        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              ...
              <br />
              <span className="text-foreground">Ukimu Chakula</span>
            </h1>
            
            <p className="text-xl text-muted-foreground leading-relaxed max-w-xl">
              Punguza hasara za chakula kwa 70% ukitumia AI na ubashiri wa hali ya hewa. 
              Jua ni chakula gani cha kuhifadhi na kutayarisha kila siku.
            </p>
            ...
            <div className="flex flex-wrap gap-6 pt-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-foreground">70% Less Waste</p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-foreground">Weather Smart</p>
          ...
          <div className="relative lg:h-[600px] h-[400px] animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <div className="absolute -bottom-6 -left-6 bg-white dark:bg-card p-6 rounded-2xl shadow-xl border border-border">
              <p className="text-sm text-muted-foreground mb-1">Hifadhi leo</p>
